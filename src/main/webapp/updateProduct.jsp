...
<form action="update" class="container" method="post">
    ...
    <h3 style='text-align: center; color: #07ee39;'>Update Product</h3>
    <div class="row">
        <div class="col-md-6">
         <div class="design">
                <label for="id">Id</label><br>
                <input type="tel" name="id" id="id"  value="${id}">
            </div>
            <div class="design">
            ...
            <div class="design">
                ...
                <input type="number" name="productPrice" id="productPrice" placeholder="Enter product price" value="${product.productPrice}">
            </div>
            <br>
        </div>
        <div class="col">
            <div class="design">
                ...
                <input type="number" name="deliveryCharge" id="deliveryCharge" placeholder="Enter delivery charge" value="${product.deliveryCharge}">
            </div>
            <br>
            <div class="design">
                <label for="description">Description</label><br>
                <textarea name="description" id="description" placeholder="Enter description" rows="3">${product.description}</textarea>
            </div>
            <br>
            <div class="design">
                <label for="available">Available</label><br>
                <input type="text" name="available" id="available" placeholder="Available or not" value="${product.available}">
            </div>
            <br>
        </div>
    </div>
    <div class="design">
        <button type="submit" class="btn btn-primary d-block mx-auto" id="button">Update</button>
    </div>
</form>
